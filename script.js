...
function gameOver(playerWon) {
    ...
    if (playerWon) {
        ...
        gameMessage.textContent = 'Game over, you lost :(';
...
function drawEverything() {
    ...
    canvasContext.fillStyle = 'rgb(36, 149, 255)';
    ...
    canvasContext.fillStyle = 'rgb(187, 224, 255)';
    ...
    canvasContext.strokeStyle = 'rgb(187, 224, 255)';
    canvasContext.beginPath();
